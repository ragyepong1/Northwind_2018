...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:ObjectDataSource ID="InventoryDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetInventoryStatus" TypeName="NorthwindTraders.BLL.ProductCatalogueController">
